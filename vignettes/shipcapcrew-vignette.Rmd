...
`add_scores`: Creates a data frame, appends the latest player score, and presents this information to the user as a as a gamecard.
...
This function initializes a two-player game. It reads in the number of games the user would like to be simulated, the strategies the player would like the simulation to use, and indicates that the gameplay is multiplayer. It returns a data frame containing player scores and strategies for each simulated game.
